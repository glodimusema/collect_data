...
import DataAuteur from './views/backend/Collects/DataAuteur.vue'
import DataEnquette from './views/backend/Collects/DataEnquette.vue'
import DataEthni from './views/backend/Collects/DataEthni.vue'
import DataGenre from './views/backend/Collects/DataGenre.vue'
import DataViolation from './views/backend/Collects/DataViolation.vue'
import CollectRapports from './views/backend/Collects/CollectRapports.vue'
//CollectRapports
...
const Router = new VueRouter({
  ...
  routes: [
    ...
    */
    ...
    {
        path: '/admin/DataAuteur',
        name: 'DataAuteur',
        component: DataAuteur,
    },
    {
        path: '/admin/DataEnquette',
        name: 'DataEnquette',
        component: DataEnquette,
    },
    {
        path: '/admin/DataEthni',
        name: 'DataEthni',
        component: DataEthni,
    },
    {
        path: '/admin/DataGenre',
        name: 'DataGenre',
        component: DataGenre,
    },
    {
        path: '/admin/DataViolation',
        name: 'DataViolation',
        component: DataViolation,
    },
    {
        path: '/admin/CollectRapports',
        name: 'CollectRapports',
        component: CollectRapports,
    },    
