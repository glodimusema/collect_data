    ...
    testLink() {
      if (this.userData.id_role == 1) {
        this.linkAdmin = {
          ...
          listTaxe: [
            {
              text: "Collect de Données",
              icon: "book",
              items: [                
                {
                  text: "Enquetes",
                  href: "/admin/DataEnquette",
                },
                {
                  text: "Type Violation",
                  href: "/admin/DataViolation",
                },
                {
                  text: "Les Ethnis",
                  href: "/admin/DataEthni",
                },
                {
                  text: "Type Auteur",
                  href: "/admin/DataAuteur",
                },
                { //CollectRapports
                  text: "Type Genre",
                  href: "/admin/DataGenre",
                },
                { //
                  text: "Rapports",
                  href: "/admin/CollectRapports",
                },
              ],
            }
          ],
