...
use App\Http\Controllers\Collects\tdata_auteurController;
use App\Http\Controllers\Collects\tdata_ethniController;
use App\Http\Controllers\Collects\tdata_genreController;
use App\Http\Controllers\Collects\tdata_violationController;
use App\Http\Controllers\Collects\tdata_enqueteController;
use App\Http\Controllers\Collects\tCollectRapportPdfController;
//
...
Route::get("fetch_all_data_auteur",[tdata_auteurController::class, 'index']);
Route::get("fetch_data_auteur2",[tdata_auteurController::class,'fetch_dropdown_2']);
Route::get("fetch_single_data_auteur/{id}",[tdata_auteurController::class,'edit']);
Route::post('insert_data_auteur',[tdata_auteurController::class, 'store']);
Route::post('update_data_auteur/{id}', [tdata_auteurController::class, 'store']);
Route::get("delete_data_auteur/{id}", [tdata_auteurController::class, 'destroy']);

Route::get("fetch_all_data_ethni",[tdata_ethniController::class, 'index']);
Route::get("fetch_data_ethni2",[tdata_ethniController::class,'fetch_dropdown_2']);
Route::get("fetch_single_data_ethni/{id}",[tdata_ethniController::class,'edit']);
Route::post('insert_data_ethni',[tdata_ethniController::class, 'store']);
Route::post('update_data_ethni/{id}', [tdata_ethniController::class, 'store']);
Route::get("delete_data_ethni/{id}", [tdata_ethniController::class, 'destroy']);

Route::get("fetch_all_data_genre",[tdata_genreController::class, 'index']);
Route::get("fetch_data_genre2",[tdata_genreController::class,'fetch_dropdown_2']);
Route::get("fetch_single_data_genre/{id}",[tdata_genreController::class,'edit']);
Route::post('insert_data_genre',[tdata_genreController::class, 'store']);
Route::post('update_data_genre/{id}', [tdata_genreController::class, 'store']);
Route::get("delete_data_genre/{id}", [tdata_genreController::class, 'destroy']);
 
Route::get("fetch_all_data_violation",[tdata_violationController::class, 'index']);
Route::get("fetch_data_violation2",[tdata_violationController::class,'fetch_dropdown_2']);
Route::get("fetch_single_data_violation/{id}",[tdata_violationController::class,'edit']);
Route::post('insert_data_violation',[tdata_violationController::class, 'store']);
Route::post('update_data_violation/{id}', [tdata_violationController::class, 'store']);
Route::get("delete_data_violation/{id}", [tdata_violationController::class, 'destroy']);

Route::get("fetch_all_data_enquete",[tdata_enqueteController::class, 'index']);
Route::get("fetch_data_enquete2",[tdata_enqueteController::class,'fetch_dropdown_2']);
Route::get("fetch_single_data_enquete/{id}",[tdata_enqueteController::class,'edit']);
Route::post('insert_data_enquete',[tdata_enqueteController::class, 'store']);
Route::post('update_data_enquete/{id}', [tdata_enqueteController::class, 'store']);
Route::get("delete_data_enquete/{id}", [tdata_enqueteController::class, 'destroy']);

Route::get("pdf_detail_enquete_excel",[tCollectRapportPdfController::class, 'pdf_detail_enquete_excel']);
